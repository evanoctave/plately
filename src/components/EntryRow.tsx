...
function makeStyles(p: ReturnType<typeof useTheme>) {
  return StyleSheet.create({
    ...
    pressed: { opacity: 0.6 },
    thumb: { width: 40, height: 40, borderRadius: radius.md, backgroundColor: p.surfaceAlt },
    iconThumb: {
      width: 40,
      height: 40,
    ...
    meta: { color: p.textMuted, fontSize: font.size.sm, marginTop: 2 },
    right: { alignItems: 'flex-end' },
    kcal: { color: p.text, fontSize: font.size.lg, fontFamily: font.family.monoBold },
    kcalUnit: { color: p.textFaint, fontSize: font.size.xs },
  });
}
