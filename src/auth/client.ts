...
// =============================================================================
// Creates the one Supabase client the app shares. Sessions persist encrypted
// at rest — AES key in the Keychain, ciphertext in AsyncStorage — and
// auto-refresh. When Supabase isn't configured (no keys in .env), `supabase`
// is null and every caller falls back to local / guest mode.
